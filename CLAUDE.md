...
**Public CI candidate (2026-09-14):** user approved a reviewed commit/push to `validation/alpha-2026-09-14`, not a merge/tag/release. GitHub connected; local main has25 unpublished commits, retained as candidate ancestry. Focused publication/source review and fresh bounded secret/license checks passed; CI result must be tied to the pushed SHA. Production and native test profiles untouched. [Scope](docs/aaa-rebuild/2026-09-14-validation-candidate.md).
