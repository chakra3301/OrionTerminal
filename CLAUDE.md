...
- All frontend (hot-reloads, no restart). tsc / **121 tests** (107→121) / vite build green. Commits: `acb1ca3` rgba sweep, `e36a59f`+`220570e` docs/plan, `778b387` P2b core, + this slice.
